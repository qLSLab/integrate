...
* Usage: `python pipeline/metaboliteIdentification.py modelName outputFileName`
* Inputs:
  * modelName: file name of the input generic model
...
* Inputs:
  ...
  * rasNormFileName: output file name of Step 3
  Users may also decided to set the following input files differently from the default imposed ones. Otherwise, these files can be left associated to the already imposed values:
