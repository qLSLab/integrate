...
f.savefig("outputs/ProteinsvsCells.png")
...
f.savefig("outputs/CellsVsTime.png")
...
f.savefig("outputs/ProteinsVsTime.png")
...
metIDConversion=pd.read_csv('data/metsEngroVsMetabolomics.csv',sep=';')
...
datasetClustering=pd.read_csv('data/metabolomics_LM.csv',sep=';',index_col=0)
...
dp.savefig("outputs/dotplot.png")
